...
export default function Hero() {
  return (
    <div className="relative min-h-[90vh] flex items-center pt-24 pb-12 overflow-hidden border-b border-divider">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02] select-none pointer-events-none">
        <h1 className="text-[200px] md:text-[320px] font-black tracking-tighter whitespace-nowrap">ANVESHAN</h1>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-2xl relative">
            ...
            >
              ...
              <h1 className="text-[80px] sm:text-[100px] lg:text-[120px] font-black leading-[0.85] tracking-tighter text-primary mb-8 uppercase">
                Anveshan<span className="text-accent">.</span>
              </h1>
              <p className="text-lg text-secondary leading-relaxed max-w-xl font-light mb-12">
          ...
          >
            ...
            <div className="relative w-full max-w-lg aspect-square rounded-full border border-divider flex items-center justify-center bg-surface">
              ...
              <motion.div
                ...
                className="relative z-10 w-48 h-48 bg-background rounded-full border border-divider-light flex items-center justify-center"
              >
                <motion.div
                  animate={{ y: [0, -6, 0] }}
                  transition={{
                ...
                >
                  ...
                  >
                    <Terminal className="w-12 h-12 text-accent mb-2" />
                  </motion.div>
                  <motion.span
                    ...
                    className="font-mono text-[10px] tracking-widest text-accent uppercase"
                  >
                    SYS.ANALYSIS
                  </motion.span>
                </motion.div>
              ...
              >
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-accent" />
              </motion.div>
              <motion.div
                animate={{ rotate: -360 }}
