...
export default function CTA() {
  return (
    <section className="py-32 relative overflow-hidden border-b border-divider">
      <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] select-none pointer-events-none">
        <Lock className="w-[800px] h-[800px]" />
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 relative z-10 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="border border-divider-light bg-surface p-12 lg:p-24"
        >
          <div className="w-12 h-12 border border-divider-light flex items-center justify-center mx-auto mb-8">
            <Lock className="w-5 h-5 text-accent" />
          </div>
          
          <h2 className="text-[40px] md:text-[60px] font-black tracking-tighter text-primary mb-8 uppercase leading-none">
            Deploy Anveshan
          </h2>
